...
class CheckListTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if UserDefaults.standard.object(forKey: "Check") != nil    {
            ...
            checkArray2 = UserDefaults.standard.object(forKey: "Check")as! [String]
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = checkArray2 [indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == UITableViewCell.EditingStyle.delete {
            checkArray2.remove(at: indexPath.row)
            tableView.deleteRows(at: [indexPath as IndexPath], with: UITableView.RowAnimation.automatic)
            print(checkArray2)
            
            //    ゾンビ化を防ぐコード
            UserDefaults.standard.set(checkArray2, forKey: "Check")}}
        // Uncomment the following line to preserve selection between presentations
        // self.clearsSelectionOnViewWillAppear = false
