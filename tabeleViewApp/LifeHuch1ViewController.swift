...
class LifeHuch1ViewController: UIViewController,UIPickerViewDataSource, UIPickerViewDelegate {


     var lifeHackArray = ["防災ライフハック","ペットボトルで簡易ランタン","ツナ缶でランプ"]
